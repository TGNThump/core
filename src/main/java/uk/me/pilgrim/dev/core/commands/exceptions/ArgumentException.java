...
public class ArgumentException extends CommandException{
	 ...
	 */
	public ArgumentException(String message, String wrongArgument, ArgumentParser parser, Class<?> expectedType){
		this(message, wrongArgument, parser, expectedType, null);
	}
	
	ArgumentException(String message, String wrongArgument, ArgumentParser parser, Class<?> expectedType, ArgumentException another){
...
//	}
	...
	public static class NotEnoughArgumentsException extends ArgumentException{
		...
		public NotEnoughArgumentsException(String message, ArgumentParser ap, Class<?> expectedType){ super(message, "", ap, expectedType); }
		public NotEnoughArgumentsException(String message, ArgumentParser ap, Class<?> expectedType, ArgumentException another){ super(message, "", ap, expectedType, another); }
	}
	...
	public static class TooManyArgumentsException extends ArgumentException{
		...
		public TooManyArgumentsException(String message, String leftArguments){ super(message, leftArguments, null, null); }
		public TooManyArgumentsException(String message, String leftArguments, ArgumentException another){ super(message, leftArguments, null, null, another); }
	}
